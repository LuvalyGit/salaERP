 ...
 */
public class jdAbrirOCCDirecto extends javax.swing.JDialog {

    String Orden;
    public jdAbrirOCCDirecto(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        Orden="";
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdAbrirOCCDirecto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdAbrirOCCDirecto dialog = new jdAbrirOCCDirecto(new javax.swing.JFrame(), true);

 ...
 */
public class jdGetClave extends javax.swing.JDialog {

    /**
     * Creates new form jdGetClave
     */
    public jdGetClave(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        txClave.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdGetClave.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdGetClave dialog = new jdGetClave(new javax.swing.JFrame(), true);

...
//        
//        
//        String sql = "SELECT  distinct p.sku, CASE WHEN id2.ids is NULL THEN '0' ELSE id2.ids END as id3,p.nombre,i.stock AS stock,p.notransado,p.desxprecio, p.sinstock, \n" +
//                     "cd.discontinuado as disc1,p.discontinuado as disc2,sum(oc.separado) as separado\n" +
//                     "FROM producto p\n" +
//                     "LEFT JOIN inventario i ON p.sku=i.sku \n" +
//                     "LEFT JOIN (SELECT sku, STRING_AGG (idch, ' - ' ORDER BY idch) AS ids FROM codchile GROUP BY sku) id2 ON (p.sku = id2.sku) \n" +
//                     "LEFT JOIN codchile cd ON p.sku = cd.sku \n" +
//                     "LEFT JOIN occhdet oc ON p.sku = oc.sku\n" +
//                     "WHERE p.sku is not null  and oc.codigo_oc <> 99999 \n" ;
//      
//        
//        if(Insumos)
...
//        
//        
//         sql = sql  + " GROUP BY p.sku, id2.ids ,p.nombre,i.stock ,p.notransado,p.desxprecio, p.sinstock, \n" +
//                      "cd.discontinuado,p.discontinuado \n";
//                         
//        
//
//        if ( cotiza ){
...
//                
//   //**********************************************************************************************************************             
//                String Query2 = "SELECT mt.cant FROM mt_productos mt\n"+
//                                "WHERE mt.sku = '" + Rs.getString("sku").toString().trim() + "' \n"+
//                                "AND mt.ubicacion IN ('TRAN.1002.1')"; 
//                
...
//                
//               
//                Query  = "SELECT  sku, stock from inventario WHERE sku = '"+Rs.getString("sku").toString().trim()+"'";
...
//                    RsEcona.next();
//                    
//                    //Stock = RsEcona.getString("stock");
//                    Stock = (RsEcona.getInt("stock")-Separado)-Ncp;
//                
//                }else {
//                
//                
...
//                            
//                            
//                                tbMd.addRow(new Object[]{Rs.getString("sku"),ID,Rs.getString("nombre"),Stock,notran,desxpr,nstock});
//                            
//                            }
//                        
//                        
...
//                            
//                            
//                                    tbMd.addRow(new Object[]{Rs.getString("sku"),"",Rs.getString("nombre"),Stock,notran,desxpr,nstock});
//                            
//                                }
//                        
//                        

 ...
 * @author DavidAlcaman
 */
public class jdAddDatosPersonaCli extends javax.swing.JDialog {
     int Cargando=0;
    public int editando=0;
    int idcontacto, rut, codigo_oc;
    public int nuevocon=0;
    int edita_contacto =0;
    /**
     * Creates new form jdAddProveedorVendedor
     */
    public jdAddDatosPersonaCli(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//        cbCargoId.setVisible(false);
    ...
    public void EditarContactoPrv(String Rut, String Id){
        ...
        try {
            ...
            if(Sql.GetRowCount()>0){
                ...
                try {
                    cbCargoId.setSelectedItem(Rs.getInt("id_cargo"));
                } catch (Exception e) {
                }
            }
        ...
        try {
            ...
            if (tipo.equals("proveedor"))
                    ...
                    Rs = Sql.Select("select codigo,nombre\n" +
                                    "from par_general\n" +
                                    "where tipo='TIPCONTACTOPRV'");
                    }
            else
                {
                Rs = Sql.Select("select codigo,nombre\n" +
                                "from par_general\n" +
                                "where tipo='TIPCONTACTOCLI'");
                }
            while(Rs.next()){
    ...
    private void btAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAceptarActionPerformed
        ...
        if (nuevocon==1)
            ...
            try{
                ...
                " ("+rut+", "+codigo_oc+", '"+txNombre.getText().trim()+"', '"+txFono.getText().trim()+"', '"+txCelular.getText().trim()+"', '"+txCorreo.getText().trim()+"', "+cbCargoId.getSelectedItem()+")");
                Sql.Commit();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdAddDatosPersonaCli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdAddDatosPersonaCli dialog = new jdAddDatosPersonaCli(new javax.swing.JFrame(), true);

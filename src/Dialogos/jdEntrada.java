...
String SNumero ="";
String RutSel;
    public jdEntrada(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        txNumero.setText(SNumero);
    }
    ...
    private void initComponents() {
        ...
        txNumero.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        txNumero.setHorizontalAlignment(javax.swing.JTextField.RIGHT);
        txNumero.setText("1234567890");
        txNumero.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txNumeroKeyPressed(evt);
            }
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txNumeroKeyReleased(evt);
            }
    ...
    public String GetNumero(){
        return txNumero.getText().trim();
    }
    private void txNumeroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txNumeroKeyReleased
        if(evt.getKeyCode()== KeyEvent.VK_ENTER)
        btCerrar.doClick();
//        if(evt.getKeyCode()== KeyEvent.VK_DOWN)
       
    }//GEN-LAST:event_txNumeroKeyReleased
    ...
    private void txNumeroKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txNumeroKeyTyped
        if (Character.isLowerCase(evt.getKeyChar()))
          ...
          char c=evt.getKeyChar(); 
              ...
              getToolkit().beep(); 
              evt.consume(); 
              System.out.println("Ingresa Solo Numeros -->" + c ); 
         }  
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdEntrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdEntrada dialog = new jdEntrada(new javax.swing.JFrame(), true);

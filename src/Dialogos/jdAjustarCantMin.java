 ...
 */
public class jdAjustarCantMin extends javax.swing.JDialog {
    ...
    public jdAjustarCantMin(java.awt.Frame parent, boolean modal) {
...
//        }        
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jdAjustarCantMin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                jdAjustarCantMin dialog = new jdAjustarCantMin(new javax.swing.JFrame(), true);

...
public class pfNCPBusqueda extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        txNroOCP = new javax.swing.JTextField();
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel14)
                    .addComponent(txNroOCP, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
        ...
        cbTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Producto", "Descuento" }));
...
static public int GetCol(String Col){
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        if(txNroOCP.getText().isEmpty()) Validacion = Validacion + "Falta Numero de la Nota de Crédito\n";
...
//                }
        ...
        try {
            ...
            Sql.ExeSql("insert into ctacteprv \n" +
                        ...
                        ",4)");//Los guarda como NOTA CRÉDITO por defecto
            // Detalle
            String Recibido="";
            for(int i=0; i< Grilla.getRowCount(); i++){
                    if(cbTipo.getSelectedIndex()==0)
...
private void Sumador(){    
    ...
    private javax.swing.JTextField txNroOCP;
